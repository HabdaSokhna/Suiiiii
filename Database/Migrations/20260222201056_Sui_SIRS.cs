...
{
    /// <inheritdoc />
    public partial class Sui_SIRS : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Report_PredictedCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    AiTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Citizen_ID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
